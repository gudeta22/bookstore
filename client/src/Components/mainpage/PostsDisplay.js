...
function Posts() {
  ...
  return (
    <div className="flex min-h-screen p-4 my-14">
      <div
      ...
      >
        <div className="inline-flex" style={{ width: '200%' }}>
          ...
          {[...posts, ...posts].map((post) => (
            <div
              key={post.id}
              className="relative bg-white rounded-lg shadow-md m-2 flex-none w-80 h-96"
              style={{ flex: '0 0 auto' }} // Ensure posts don't shrink
            >
